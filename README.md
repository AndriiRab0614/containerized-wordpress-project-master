...
_If you're interested in running WordPress on Kubernetes please refer to my [wp-k8s project]._
...
#### [ansible-role-python-centos-bootstrap]
...
#### [ansible-role-centos-docker-compose-setup]
